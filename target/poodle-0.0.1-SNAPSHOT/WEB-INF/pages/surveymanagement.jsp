		...
		<c:forEach var="survey" items="${surveyList}">
   			<tr class="odd">
						...
						<td><button  onclick="location.href='/poodle/campaignmanagement/surveys/<c:out value="${campaignId}"/>/modifySurvey/<c:out value="${survey.id}"/>.htm'" >
							...
							<button  onclick="location.href='/poodle/campaignmanagement/surveys/<c:out value="${campaignId}"/>/sendEmail/<c:out value="${survey.id}"/>.htm'" >
							Send e-mail to users</button></td>
					</tr>
		</c:forEach>
	</table>
</div>
